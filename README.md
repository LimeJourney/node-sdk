...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/LimeJourney/node-sdk/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/LimeJourney/node-sdk/issues) with questions, bugs, or suggestions.
...
- Deno v1.28.0 or higher, using `import Limejourney from "npm:limejourney"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
